...
def mormf_set1(E, l, Bt, sig,tau, norm, f0, mu, Ein):


    """
    Model response function for X-ray RMF set_1 [E = 0.4175 - 1.8375 keV].

    This model simulates the detector response to an incident X-ray photon energy having just the primary peak,
    incorporating attenuation and charge loss effects across two regions transitioning at length l from func1 
    to func2.
